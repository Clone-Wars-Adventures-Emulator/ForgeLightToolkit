Shader "FLTK/Built-In/RuntimeTerrain_5"
{
    Properties
    {
        ...
        _DetailRepeat4("DetailRepeat4", Float) = 0.0
        ...
        _DetailColorMap4("DetailColorMap4", 2D) = "white" {}
    }
    SubShader
    {
...
#pragma surface surf Standard fullforwardshadows addshadow
        ...
        void surf(Input IN, inout SurfaceOutputStandard o)
        {
            ...
            float4 detail4 = tex2D(_DetailColorMap4, IN.uv2_DetailMaskMap * _DetailRepeat4);

            float4 r5 = lerp(detail0, detail1, mask.r);
            float4 r4 = lerp(r5, detail2, mask.a);
            float4 r3 = lerp(r4, detail3, mask.g);
            float4 r0 = lerp(r3, detail4, mask.b);
